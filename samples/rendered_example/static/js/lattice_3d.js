...
(function () {
  ...
  // (finding / observation / section_anchor / composite) and segment
  // anchors live here so they stay visible when you zoom past atom
  // detail. Hand-curated null-kind nodes also surface at level 2+
  // (handled in isVisibleAtResolution).
  var MID_KINDS = {
